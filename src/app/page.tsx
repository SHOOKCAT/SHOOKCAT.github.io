  ...
  return (
    <main>
      <div className="relative isolate min-h-screen overflow-hidden">
        ...
        <div className="relative z-20 px-4 sm:px-6 pt-14 lg:px-8">
          <div className="mx-auto max-w-2xl py-16 sm:py-32 lg:py-48">
            <div className="text-center">
              <h1 className="hero-title text-3xl sm:text-4xl font-bold tracking-tight text-white lg:text-6xl mb-4 sm:mb-8">
                Help Save Conan
              </h1>
              <p className="text-base sm:text-lg leading-8 text-gray-300 mb-8 sm:mb-12 px-4">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4 px-4">
                <a href="#help" className="w-full sm:w-auto primary-button rounded-md px-6 py-3 text-white font-semibold">
                  Sign the Petition
                </a>
                <a href="#token" className="w-full sm:w-auto secondary-button rounded-md px-6 py-3 text-white font-semibold">
                  Support $CONAN
                </a>
              </div>
